...
public class DashboardUpgris extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upgrisdashboard);
        ...
        imglistmhs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardUpgris.this, MainActivityUpgris.class);
    ...
    public void openpieChart(View view) {
        Intent intent = new Intent(this, ChartActivityUpgris.class);
