...
public class DashboardIvet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ivetdashboard);
        ...
        imglistmhs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardIvet.this, MainActivityIvet.class);
    ...
    public void openpieChart(View view) {
        Intent intent = new Intent(this, ChartActivityIvet.class);
