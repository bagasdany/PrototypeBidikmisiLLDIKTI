...
public class EditorActivityAdmin extends AppCompatActivity {
    ...
    public static final int KAMPUS_UNKNOWN = 0;
    public static final int KAMPUS_UNIKA = 1;
    public static final int KAMPUS_UDINUS = 2;
    public static final int KAMPUS_USM = 3;
    public static final int KAMPUS_UNISBANK = 4;
    public static final int KAMPUS_UPGRIS = 5;
    public static final int KAMPUS_UNIMUS = 6;
    public static final int KAMPUS_UNWAHAS = 7;
    public static final int KAMPUS_IVET= 8;
    public static final int KAMPUS_UNISSULA = 9;
    public static final int KAMPUS_UNTAG = 10;
    public static final int KAMPUS_ADMIN = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admineditor);
        ...
        mBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditorActivityAdmin.this, date, myCalendar
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            Glide.with(EditorActivityAdmin.this)
                    .load(picture)
            ...
            switch (universitas) {
                ...
                case KAMPUS_USM:
                    ...
                    break;
                case KAMPUS_UNISBANK:
                    mUniversitasspinner.setSelection(4);
                    break;
                case KAMPUS_UPGRIS:
                    mUniversitasspinner.setSelection(5);
                    break;
                case KAMPUS_UNIMUS:
                    mUniversitasspinner.setSelection(6);
                    break;
                case KAMPUS_UNWAHAS:
                    mUniversitasspinner.setSelection(7);
                    break;
                case KAMPUS_IVET:
                    mUniversitasspinner.setSelection(8);
                    break;
                case KAMPUS_UNISSULA:
                    mUniversitasspinner.setSelection(9);
                    break;
                case KAMPUS_UNTAG:
                    mUniversitasspinner.setSelection(10);
                    break;
                case KAMPUS_ADMIN:
                    mUniversitasspinner.setSelection(11);
                    break;
                default:
    ...
    private void setupSpinner(){
        ...
        ArrayAdapter KampusSpinner = ArrayAdapter.createFromResource(this, R.array.array_admin_options, android.R.layout.simple_spinner_item);
        ...
        mUniversitasspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    }else if (selection.equals(getString(R.string.kampus_unisbank))) {
                        mUniversitas = KAMPUS_UNISBANK;
                    }else if (selection.equals(getString(R.string.kampus_upgris))) {
                        mUniversitas = KAMPUS_UPGRIS;
                    }else if (selection.equals(getString(R.string.kampus_unimus))) {
                        mUniversitas = KAMPUS_UNIMUS;
                    }else if (selection.equals(getString(R.string.kampus_unwahas))) {
                        mUniversitas = KAMPUS_UNWAHAS;
                    }else if (selection.equals(getString(R.string.kampus_ivet))) {
                        mUniversitas = KAMPUS_IVET;
                    }else if (selection.equals(getString(R.string.kampus_unissula))) {
                        mUniversitas = KAMPUS_UNISSULA;
                    }else if (selection.equals(getString(R.string.kampus_untag))) {
                        mUniversitas = KAMPUS_UNTAG;
                    }else if (selection.equals(getString(R.string.admin))) {
                        mUniversitas = KAMPUS_ADMIN;
                    } else {
                        mUniversitas = KAMPUS_UNKNOWN;
                    }
                }
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_save:
                ...
                if (id == 0) {
                    ...
                    if (TextUtils.isEmpty(mName.getText().toString()) ||
                        ...
                        alertDialog.setMessage("Please complete Nama,Semester,dan Tanggal Lahir!");
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorActivityAdmin.this);
    ...
    private void postData(final String key) {
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(EditorActivityAdmin.class.getSimpleName(), response.toString());
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorActivityAdmin.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorActivityAdmin.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
