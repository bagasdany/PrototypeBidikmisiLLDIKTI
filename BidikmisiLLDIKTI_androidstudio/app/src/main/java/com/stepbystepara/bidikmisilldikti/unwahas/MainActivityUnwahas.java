...
public class MainActivityUnwahas extends AppCompatActivity {
...
//    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unwahasmain);
...
//        sm.checkLogin();
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(MainActivityUnwahas.this, EditorActivityUnwahas.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivityUnwahas.this, EditorActivityUnwahas.class));
            }
        });
    ...
    public void getUnwahas(){

        Call<List<Mahasiswa>> call = apiInterface.getUnwahas();
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                ...
                Log.i(MainActivityUnwahas.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(mhsList, MainActivityUnwahas.this, listener);
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                Toast.makeText(MainActivityUnwahas.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(MainActivityUnwahas.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(MainActivityUnwahas.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivityUnwahas.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                Toast.makeText(MainActivityUnwahas.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
