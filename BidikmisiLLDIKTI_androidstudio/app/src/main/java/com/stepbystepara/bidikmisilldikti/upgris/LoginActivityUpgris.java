...
public class LoginActivityUpgris extends AppCompatActivity {
    private EditText edtUsername, edtPassword,edtid;
    private Button btnLogin;
    private ProgressDialog pd;
    private static final String TAG = LoginActivityUpgris.class.getSimpleName();
//    private SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upgrislogin);
        edtUsername =  findViewById(R.id.edtUsername);
        edtPassword =  findViewById(R.id.edtPassword);

        btnLogin =  findViewById(R.id.btnLogin);
        pd = new ProgressDialog(LoginActivityUpgris.this);
//        sm = new SessionManager(LoginActivity.this);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<ResponseApiModel> login = Api.loginupgris(edtUsername.getText().toString(),edtPassword.getText().toString());
...
//                            sm.storeLogin(user.get(0).getUsername(),user.get(0).getKampususer());
                            Toast.makeText(LoginActivityUpgris.this, "Semangat Mengisi Data" , Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(LoginActivityUpgris.this, DashboardUpgris.class);
//                            intent.putExtra("id",user.get(0).getIduser());
                        ...
                        {
                            Toast.makeText(LoginActivityUpgris.this, "username tidak cocok", Toast.LENGTH_SHORT).show();
                        }
                    }
