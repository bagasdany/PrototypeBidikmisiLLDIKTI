 ...
 */
public class ChartFragmentUnisbank extends Fragment {
    private BarChart mBarChart;
    private PieChart mPieChart;

    public ChartFragmentUnisbank() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.unisbankfragment, container, false);
    ...
    private void getGrowthChart(final String method) {
        ...
        Call<List<Mahasiswa>> call = ApiClient.getApiClient().create(ApiInterface.class).getUnisbank();
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                if (response.body()!=null)
                {
                    if (method.equals("piedana"))
                    {
                        ...
                        {
                            if ((growth.getStatusdana())==2  && (growth.getUniversitas())==4){
                    ...
                    else if (method.equals("pie"))
                    {
                        ...
                        for (Mahasiswa growth : response.body())
                        {
                            if (Float.parseFloat(growth.getTotalipk())<3  && (growth.getUniversitas())==4){
                    ...
                    else if (method.equals("pieprestasi"))
                    {
                        ...
                        for (Mahasiswa growth : response.body())
                        {
                            if (Float.parseFloat(growth.getJumlahprestasi())>0  && (growth.getUniversitas())==4){
