...
public class MainActivityUnissula extends AppCompatActivity {
...
//    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unissulamain);
...
//        sm.checkLogin();
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(MainActivityUnissula.this, EditorActivityUnissula.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivityUnissula.this, EditorActivityUnissula.class));
            }
        });
    ...
    public void getUnissula(){

        Call<List<Mahasiswa>> call = apiInterface.getUnissula();
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                ...
                Log.i(MainActivityUnissula.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(mhsList, MainActivityUnissula.this, listener);
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                Toast.makeText(MainActivityUnissula.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(MainActivityUnissula.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(MainActivityUnissula.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivityUnissula.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                Toast.makeText(MainActivityUnissula.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
