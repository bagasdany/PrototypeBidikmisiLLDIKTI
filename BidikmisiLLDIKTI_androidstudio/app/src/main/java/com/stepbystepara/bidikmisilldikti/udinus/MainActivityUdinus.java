...
public class MainActivityUdinus extends AppCompatActivity {
...
//    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.udinusmain);
...
//        sm.checkLogin();
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(MainActivityUdinus.this, EditorActivityUdinus.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivityUdinus.this, EditorActivityUdinus.class));
            }
        });
    ...
    public void getUdinus(){

        Call<List<Mahasiswa>> call = apiInterface.getUdinus();
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                ...
                Log.i(MainActivityUdinus.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(mhsList, MainActivityUdinus.this, listener);
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                Toast.makeText(MainActivityUdinus.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(MainActivityUdinus.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(MainActivityUdinus.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivityUdinus.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                Toast.makeText(MainActivityUdinus.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
