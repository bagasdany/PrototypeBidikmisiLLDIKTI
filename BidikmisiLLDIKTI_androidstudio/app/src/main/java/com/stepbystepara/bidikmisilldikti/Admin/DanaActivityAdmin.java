...
public class DanaActivityAdmin extends AppCompatActivity {
...
//        sm.checkLogin();
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(DanaActivityAdmin.this, EditorActivityAdmin.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(DanaActivityAdmin.this, EditorActivityAdmin.class));
            }
        });
    ...
    public void getAdmindana(){

        Call<List<Mahasiswa>> call = apiInterface.getAdmindana();
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                ...
                Log.i(DanaActivityAdmin.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(mhsList, DanaActivityAdmin.this, listener);
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                Toast.makeText(DanaActivityAdmin.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(DanaActivityAdmin.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(DanaActivityAdmin.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(DanaActivityAdmin.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                Toast.makeText(DanaActivityAdmin.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
