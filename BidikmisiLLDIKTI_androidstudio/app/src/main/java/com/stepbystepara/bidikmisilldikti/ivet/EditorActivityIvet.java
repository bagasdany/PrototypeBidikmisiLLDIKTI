...
public class EditorActivityIvet extends AppCompatActivity {
    ...
    public static final int STATUS_NONAKTIF = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.iveteditor);
        ...
        mBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditorActivityIvet.this, date, myCalendar
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            Glide.with(EditorActivityIvet.this)
                    .load(picture)
            ...
            switch (statusbidikmisi) {
                ...
                case STATUS_NONAKTIF:
                    mStatusbidikmisispinner.setSelection(3);
                    break;
                default:
    ...
    private void setupSpinner(){
        ...
        mStatusbidikmisispinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    }else if (selection.equals(getString(R.string.status_nonaktif))) {
                        mStatusbidikmisi = STATUS_NONAKTIF;
                    }
                    else {
                        mStatusbidikmisi = STATUS;
                    }
                }
            }
        ...
        ArrayAdapter KampusSpinner = ArrayAdapter.createFromResource(this, R.array.array_kampusivet_options, android.R.layout.simple_spinner_item);
        ...
        mUniversitasspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String selection = (String) parent.getItemAtPosition(position);
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.kampus_ivet))) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorActivityIvet.this);
    ...
    private void postData(final String key) {
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(EditorActivityIvet.class.getSimpleName(), response.toString());
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorActivityIvet.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorActivityIvet.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
