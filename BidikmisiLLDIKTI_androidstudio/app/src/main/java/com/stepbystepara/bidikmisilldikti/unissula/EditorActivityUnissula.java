...
public class EditorActivityUnissula extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unissulaeditor);
        ...
        mBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditorActivityUnissula.this, date, myCalendar
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            Glide.with(EditorActivityUnissula.this)
                    .load(picture)
    ...
    private void setupSpinner(){
        ...
        ArrayAdapter KampusSpinner = ArrayAdapter.createFromResource(this, R.array.array_kampusunissula_options, android.R.layout.simple_spinner_item);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorActivityUnissula.this);
    ...
    private void postData(final String key) {
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(EditorActivityUnissula.class.getSimpleName(), response.toString());
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorActivityUnissula.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorActivityUnissula.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
