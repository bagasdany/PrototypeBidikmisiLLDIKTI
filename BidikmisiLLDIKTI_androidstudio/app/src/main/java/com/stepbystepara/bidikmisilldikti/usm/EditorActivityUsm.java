...
public class EditorActivityUsm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.usmeditor);
        ...
        mBirth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditorActivityUsm.this, date, myCalendar
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            Glide.with(EditorActivityUsm.this)
                    .load(picture)
    ...
    private void setupSpinner(){
        ...
        ArrayAdapter KampusSpinner = ArrayAdapter.createFromResource(this, R.array.array_kampususm_options, android.R.layout.simple_spinner_item);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorActivityUsm.this);
    ...
    private void postData(final String key) {
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(EditorActivityUsm.class.getSimpleName(), response.toString());
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorActivityUsm.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorActivityUsm.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
