...
public class DashboardUnisbank extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unisbankdashboard);
        ...
        imglistmhs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DashboardUnisbank.this, MainActivityUnisbank.class);
    ...
    public void openpieChart(View view) {
        Intent intent = new Intent(this, ChartActivityUnisbank.class);
