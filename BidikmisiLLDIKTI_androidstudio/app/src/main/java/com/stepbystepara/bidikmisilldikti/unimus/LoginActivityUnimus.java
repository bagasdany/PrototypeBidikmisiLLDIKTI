...
public class LoginActivityUnimus extends AppCompatActivity {
    private EditText edtUsername, edtPassword,edtid;
    private Button btnLogin;
    private ProgressDialog pd;
    private static final String TAG = LoginActivityUnimus.class.getSimpleName();
//    private SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unimuslogin);
        edtUsername =  findViewById(R.id.edtUsername);
        edtPassword =  findViewById(R.id.edtPassword);

        btnLogin =  findViewById(R.id.btnLogin);
        pd = new ProgressDialog(LoginActivityUnimus.this);
//        sm = new SessionManager(LoginActivity.this);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Call<ResponseApiModel> login = Api.loginunimus(edtUsername.getText().toString(),edtPassword.getText().toString());
...
//                            sm.storeLogin(user.get(0).getUsername(),user.get(0).getKampususer());
                            Toast.makeText(LoginActivityUnimus.this, "Semangat Mengisi Data" , Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(LoginActivityUnimus.this, DashboardUnimus.class);
//                            intent.putExtra("id",user.get(0).getIduser());
                        ...
                        {
                            Toast.makeText(LoginActivityUnimus.this, "username tidak cocok", Toast.LENGTH_SHORT).show();
                        }
                    }
