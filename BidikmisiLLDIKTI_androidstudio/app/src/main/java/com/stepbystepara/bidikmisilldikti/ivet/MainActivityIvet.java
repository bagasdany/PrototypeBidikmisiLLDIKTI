...
public class MainActivityIvet extends AppCompatActivity {
...
//    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ivetmain);
...
//        sm.checkLogin();
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(MainActivityIvet.this, EditorActivityIvet.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainActivityIvet.this, EditorActivityIvet.class));
            }
        });
    ...
    public void getIvet(){
        ...
        Call<List<Mahasiswa>> call = apiInterface.getIvet();
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                ...
                Log.i(MainActivityIvet.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(mhsList, MainActivityIvet.this, listener);
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                Toast.makeText(MainActivityIvet.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(MainActivityIvet.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(MainActivityIvet.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivityIvet.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                Toast.makeText(MainActivityIvet.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
