...
public class MhsMundurActivityAdmin extends AppCompatActivity {
...
//    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adminipkmain);
...
//        sm.checkLogin();
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(MhsMundurActivityAdmin.this, EditorActivityAdmin.class);
                ...
                intent.putExtra("universitas", mhsList.get(position).getUniversitas());
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MhsMundurActivityAdmin.this, EditorActivityAdmin.class));
            }
        });
    ...
    public void getAdminmhsmundur(){

        Call<List<Mahasiswa>> call = apiInterface.getAdminmhsmundur();
        call.enqueue(new Callback<List<Mahasiswa>>() {
            ...
            public void onResponse(Call<List<Mahasiswa>> call, Response<List<Mahasiswa>> response) {
                ...
                Log.i(MhsMundurActivityAdmin.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(mhsList, MhsMundurActivityAdmin.this, listener);
            ...
            public void onFailure(Call<List<Mahasiswa>> call, Throwable t) {
                Toast.makeText(MhsMundurActivityAdmin.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Mahasiswa>() {
            ...
            public void onResponse(Call<Mahasiswa> call, Response<Mahasiswa> response) {
                ...
                Log.i(MhsMundurActivityAdmin.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(MhsMundurActivityAdmin.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MhsMundurActivityAdmin.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Mahasiswa> call, Throwable t) {
                Toast.makeText(MhsMundurActivityAdmin.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
